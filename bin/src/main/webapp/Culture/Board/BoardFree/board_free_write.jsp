	...
	<div id="template">
		<div id="container">
			...
			<form action="" method="post">
				...
				<input type="hidden" id="board_writer" name="board_writer" value="{'홍길동'}">
				<div align="right">
					...
					<button th:formaction="@{/BoardFree/board_free_write/board_write}" type="submit" class="btn btn-primary pull-right" id="board_submit" style="background-color:#FFFFFF; color: #6667AB; border: 1px solid #6667AB">제출하기</button>
				</div>
			</form>
		</div>
	</div>
