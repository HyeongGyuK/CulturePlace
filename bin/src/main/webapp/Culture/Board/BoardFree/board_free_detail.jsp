		...
		<div id="container">
			...
			<table class="table table-striped" id="comment_table">
				...
				<td colspan="10" align="center">
					...
					<a href="/BoardFree/board_free_update" class="btn btn-primary pull-right" id="boardUpdateBtn" style="background-color:#FFFFFF; color: #6667AB; border: 1px solid #6667AB; box-sizing:border-box; margin-top: 10px;"><b>수정</b></a>
